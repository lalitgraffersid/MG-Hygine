              ...
              <div class="card">
               ...
               <?php if(!empty($data['checkRole']) && (Auth::user()->user_type == 'admin' || !empty($data['checkPermission']))): ?>
                  <div class="card-header float-right">
                     <a href="<?php echo e(route('brands.add')); ?>" class="btn btn-info float-right"><i class="fas fa-plus"></i> <?php echo e($data['actionData']->action_title); ?> </a>
                  </div>
               <?php endif; ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/mg_hygiene/resources/views/admin/brands/index.blade.php ENDPATH**/ ?>