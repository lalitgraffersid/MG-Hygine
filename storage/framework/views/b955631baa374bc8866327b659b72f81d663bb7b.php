        ...
        <div class="row">
            <div class="col-md-12">
                <div class="headeing_image">
                    ...
                    <p><strong><a style="color: #fff;" href="<?php echo e(route('home')); ?>">Home ></a></strong> <span>Our Environment</span></p>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/mg_hygiene/resources/views/front/our_environment/index.blade.php ENDPATH**/ ?>