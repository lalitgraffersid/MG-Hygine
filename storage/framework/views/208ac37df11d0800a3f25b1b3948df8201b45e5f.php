<!-- /.content-wrapper -->
  <footer class="main-footer">
    <strong>Copyright &copy; <?php echo date('Y-m-d'); ?> <a href="#">MG Hygiene</a>.</strong>
    All rights reserved.
...
<script src="<?php echo e(asset('assets/admin/plugins/bootstrap-switch/js/bootstrap-switch.min.js')); ?>"></script>
<!-- AdminLTE App -->
...
</html><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/mg_hygiene/resources/views/admin/includes/footer.blade.php ENDPATH**/ ?>