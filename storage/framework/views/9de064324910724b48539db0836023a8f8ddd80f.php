...
<body>
                ...
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ">
                            ...
                            <li class="dropdown">
  <a class="dropbtn nav-link <?php echo e($current_route == 'our_brands' ? 'cont' : ''); ?>" href="<?php echo e(route('our_brands')); ?>">PRODUCTS</a>
  ...
  <ul class="dropdown-content" style="left:0;">
   ...
   <li> <a href="https://testdmcconsultancy.com/demo/mg_hygiene/products/sacksbin-liners-bins">Sacks,Bin Liners & Bins	</a></li>
    ...
    <!-- end header section --><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/mg_hygiene/resources/views/front/includes/head.blade.php ENDPATH**/ ?>