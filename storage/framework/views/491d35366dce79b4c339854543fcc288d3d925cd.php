		            	...
		            	<p>County<span style="color: red;">*</span></p>
		               	<select name="county" class="select12">
							<?php $__currentLoopData = $counties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $county): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($county->county); ?>"><?php echo e($county->county); ?></option>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</select>
		            </div>
		            <div class="checkout__input">
	            	...
	            	<div class="checkout__order">
	        			<div class="checkout-form-panel">
							...
							<table class="table table-bordered">
		                        ...
		                        ?>
								<tr>
									<td><?php echo e($product->title); ?>  × <?php echo e($result->quantity); ?></td>
									<td><div><span class="cart-proce-color">€ <?php echo e(number_format($result->sub_total,2)); ?></span></div></td>
								</tr>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								
								<tr>
									<th>Subtotal</th>
									<td><span class="cart-proce-color">€ <?php echo e(number_format($sub_total,2)); ?></span></td>
								</tr>

								<?php if($discount != '0' && !empty($discount)): ?>
								<tr>
									<th>Discount</th>
									<td class="cart-proce-color">€ <?php echo e(number_format($discount,2)); ?></td>
								</tr>
								<?php endif; ?>
								...
								<tr>
									<th>Shipping</th>
									<td>
										<div><label><input type="radio" name="price" checked> <?php echo e($result->shipping_method); ?>:</label> <span class="cart-proce-color">€ <?php echo e(number_format($result->shipping_price,2)); ?></span></div>
									</td>
								</tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/mg_hygiene/resources/views/front/cart/checkout.blade.php ENDPATH**/ ?>