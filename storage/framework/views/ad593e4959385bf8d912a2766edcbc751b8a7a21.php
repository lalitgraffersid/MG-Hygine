...
<?php $__env->startSection('content'); ?>
  ...
  <img class="s_li_der" src="<?php echo e(asset('assets/front/images/img/banner.png')); ?>" alt="s1lde1">
...
-->
      <div class="row">
        <div class="col-sm-6 col-lg-6">
         ...
         <img style="width: 30%;" src="<?php echo e(asset('assets/front/images/img/logo.png')); ?>" alt="">  
          </div>
        </div>
        <div class="col-sm-6 col-lg-6">
