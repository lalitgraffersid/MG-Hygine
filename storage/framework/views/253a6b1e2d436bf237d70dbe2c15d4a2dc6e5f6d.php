         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card card-primary">
                  ...
                  <?php endif; ?>
                  <form id="quickForm" action="<?php echo e(route('products.import.csv')); ?>" method="POST" enctype="multipart/form-data" >
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mg\resources\views/admin/products/import.blade.php ENDPATH**/ ?>