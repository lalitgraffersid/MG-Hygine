            ...
            <div class="col-md-12">
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">Edit <small>Brand</small></h3>
                  </div>
                  ...
                  <?php endif; ?>
                  <form id="quickForm" action="<?php echo e(route('brands.update')); ?>" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="card-body">
                        <div class="form-group">
                           ...
                           <input type="text" name="name" value="<?php echo e($result->name); ?>" class="form-control" id="name" placeholder="Brand Name">
                        </div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/mg_hygiene/resources/views/admin/brands/edit.blade.php ENDPATH**/ ?>