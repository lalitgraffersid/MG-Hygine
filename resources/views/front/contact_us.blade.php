        ...
        <div class="row">
            <div class="col-md-12">
                <div class="headeing_image">
                    <h4>Contact</h4>
                    <p><strong><a href="{{route('home')}}">Home ></a></strong> <span>Contact</span></p>
                </div>
            </div>
        </div>
    </div>
      	...
      	<div class="row d-flex mb-5 contact-info">
            ...
            <div class="col-md-4 d-flex">
                <div class="info bg-white p-4">
	               <p><span>Address :</span>  <br>{{$settings->address}}</p>
	            </div>
            </div>
            <div class="col-md-4 d-flex">
                <div class="info bg-white p-4">
	               <p><span>Ph &amp; Phone :</span> <a href="#"> <br>{{$settings->phone}}</a></p>
                </div>
            </div>
            <div class="col-md-4 d-flex">
                <div class="info bg-white p-4">
	               <p><span>Email:</span> <a href="mailto:info@yoursite.com"> <strong>{{$settings->email}}</strong></a></p>
	            </div>
            </div>
        </div>
    </div>
