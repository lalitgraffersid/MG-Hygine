                  ...
                  <form id="quickForm" action="{{route('categories.update')}}" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="card-body">
                        <div class="form-group">
                           ...
                           <select name="brand_id" class="form-control" id="brand_id">
                              ...
                              @foreach($brands as $value)
                                 <option value="{{$value->id}}" {{ $result->brand_id == $value->id ? 'selected' : '' }}>{{$value->name}}</option>
                              @endforeach
                           </select>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="title" value="{{$result->title}}" class="form-control" id="title" placeholder="Enter Title">
                        </div>
